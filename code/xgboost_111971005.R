...
binary_predictions_xg_unsmote <- ifelse(predicted_xgboost_unsmote > 0.5, 0, 1)
...
binary_predictions_xg_smote <- ifelse(predicted_xgboost_smote > 0.5, 0, 1)
...
binary_predictions_xg_smote_04 <- ifelse(predicted_xgboost_smote > 0.4, 0, 1)
...
# test xgboost threshold 0.4 0.5 0.6
binary_predictions_xg_smote_06 <- ifelse(predicted_xgboost_smote > 0.6, 0, 1)
